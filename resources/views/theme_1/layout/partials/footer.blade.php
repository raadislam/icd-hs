                ...
                <div class="info custom-info mb-4">
                    <div class="custom-info-block custom-info-block-address">
                        ...
                        <span
                            ...
                            89/17 New Chashara, Muktijoddha Farida Akter Road,Chanmari,<br> (West Side of Proposed
                            N.ganj DOHS) <br> Narayanganj-1400, Bangladrsh.
                        </span>
                    </div>
                    <div class="custom-info-block custom-info-block-phone">
                        ...
                        <span
                            class="font-weight-normal text-color-light text-custom-info-block p-relative bottom-6 text-custom-info-block-phone"><a
                                href="tel:+8801972524253" class="text-color-light">(+880) 1972524253</a></span>
                    </div>
                    ...
                    <div class="custom-info-block custom-info-block-working-days">
                        <span
                            class="text-color-default font-weight-bold text-uppercase title-custom-info-block title-custom-info-block-working-days">Working
                            Days/Hours</span>
                        <span
                            class="font-weight-normal text-color-light text-custom-info-block text-custom-info-block-working-days">
                            Sat - Thu / 8:00 AM - 5:00 PM</span>
                    </div>
                </div>
