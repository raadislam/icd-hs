                        ...
                        <div class="feature-box feature-box-style-2 align-items-center">
                            <div class="feature-box-icon">
                                <img width="34" height="28"
                                    src="{{ asset('file') }}/img/demos/law-firm/icons/envelope.svg" alt=""
                                    data-icon
                            ...
                            <div class="feature-box-info ps-1">
                                ...
                                <strong class="custom-footer-strong-1"><a href="mailto:mail@example.com"
                                        class="text-color-light">MAIL@EXAMPLE.COM</a></strong>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="feature-box feature-box-style-2 align-items-center">
                            <div class="feature-box-icon">
                                <img width="30" height="30"
                                    src="{{ asset('file') }}/img/demos/law-firm/icons/phone.svg" alt=""
                                    data-icon
                            ...
                            <div class="feature-box-info ps-1">
                                ...
                                <strong class="custom-footer-strong-1"><a href="tel:8001234567"
                                        class="text-color-light">800-123-4567</a></strong>
                            </div>
                        </div>
                    </div>
                </div>
