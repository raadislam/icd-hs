...
/*Data for the table `course_schedules` */
...
(9,'2023_12_13_164624_create_course_schedules_table',4),
(10,'2023_12_14_063535_create_therapies_table',4),
(11,'2023_12_14_065526_create_therapists_table',5);
...
insert  into `therapies`(`id`,`title`,`fee`,`description`,`created_at`,`updated_at`) values 
(1,'Special & Inclusive Education','13000','Provide better learning opportunities. Children with different abilities are often more motivated to learn together with other children.Expectations are even higher for all children.Successful inclusion requires developing individual strengths and talents.','2023-12-14 06:54:06','2023-12-14 06:54:06');
...
insert  into `therapists`(`id`,`name`,`email`,`address`,`phone_number`,`dob`,`nid`,`img`,`about`,`created_at`,`updated_at`) values 
(1,'Reasad Islam Therapy','raadislam09@gmail.com','61 Chashara, Narayanganj','01855262019','2023-12-14','0','00MPdk1A9BY5BjJ0.png','Hassan Gas has been in the profession for over 25 years. He’s specialized in addressing mental health, substance abuse, and chemical dependency. His areas of research include developmental psychology, psychoanalysis, and clinical psychology. He has served as a professor at various universities. He consults for universities. His qualifications are M.A., DSC (Doctor of Science), Ph.D., Certs NLP (NLP Practitioner). He helps people with drug abuse, addiction, stress, etc.','2023-12-14 07:18:22','2023-12-14 07:18:22');
