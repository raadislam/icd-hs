            ...
            <div class="col-sm-6 col-lg-3 footer-column footer-column-get-in-touch">
                ...
                <div class="info custom-info mb-4">
                    ...
                    <div class="custom-info-block custom-info-block-phone">
                        ...
                        <span
                            class="font-weight-normal text-color-light text-custom-info-block p-relative bottom-6 text-custom-info-block-phone">Toll
                            Free <a href="tel:+1234567890" class="text-color-light">(123) 456-7890</a></span>
                    </div>
                    ...
                    <div class="custom-info-block custom-info-block-working-days">
                        <span
                            ...
                            Days/Hours</span>
                        <span
                            class="font-weight-normal text-color-light text-custom-info-block text-custom-info-block-working-days">Mon
                            - Sun / 9:00AM - 8:00PM</span>
                    </div>
                </div>
