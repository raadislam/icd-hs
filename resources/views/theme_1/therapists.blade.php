            ...
            <div class="card border-0 mb-4 border-radius-0 box-shadow-1 mb-4">
                <div class="card-body p-3 z-index-1 text-center">
                    <a href="demo-medical-2-our-doctors-detail.html" class="d-block text-center bg-color-grey">
                        <img alt="Doctor" class="img-fluid rounded" src="{{ asset('images') }}/therapist/{{$therapist->img}}">
                    </a>
                    ...
                    <span class="text-uppercase d-block text-default font-weight-semibold text-1 p-relative bottom-4 mb-0">Therapists</span>
